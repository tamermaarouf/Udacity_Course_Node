...
const milkQ = () => {
  return new Promise((resolve, reject) => {
    rl.question('How many cups of milk to add? ', (answer: number) => {
      resolve(answer);
    });
  });
};
...
const espressoQ = () => {
  return new Promise((resolve, reject) => {
    rl.question('How many shots of espresso to add? ', (answer: number) => {
      resolve(answer);
    });
  });
};
...
const peppermintQ = () => {
  return new Promise((resolve, reject) => {
    rl.question('How many shots of peppermint to add? ', (answer: number) => {
      resolve(answer);
    });
  });
};
